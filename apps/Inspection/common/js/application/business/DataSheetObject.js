...
/**@memberOf application.business.DataSheetObject */
		...
		setEventContext: function(eventContext) {
			this.eventContext = eventContext; //IJ15606
		},
		
		getEventContext: function() {
			return this.eventContext;  //IJ15606
		},
		...
		getRelatedDSConfig: function() {
			...
			if(result == null || result.length == 0) {
				//IJ5606
				this.setDataSheetConfig(this.eventContext.application.getResource('additionaldatasheetconfig'));
				result = this.dsconfiglist.find("dsplannum == '" + dsplannum + "' && revisionnum == " + revisionnum);
