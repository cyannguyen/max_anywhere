...
/**@memberOf application.handlers.CreateNewCalibrationHandler */
		...
		initCreatePointView : function(eventContext) {
			...
			//if function check's new point, then force a change in point to enable merge in DataSheetObject
			if(this.assetfunction.calfunction){
				this.newPoint.set('asfoundpass', true);
			    this.newPoint.set('asleftpass', true);
			    this.newPoint.set('asfoundpass', null);
			    this.newPoint.set('asleftpass', null);
			}
