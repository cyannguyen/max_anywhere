...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/ItemBinRange", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.ItemBinRange", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout ItemBinRange ');

            var row = table.insertRow(-1);
            row.className  = 'ItemBinRange_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'ItemBinRange_item1_column';
            col_item1.colSpan = '6';
            ...
            col_item2.className  = 'ItemBinRange_item2_column';
            col_item2.colSpan = '6';
