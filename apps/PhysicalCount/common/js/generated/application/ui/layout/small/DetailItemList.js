...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/DetailItemList", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.DetailItemList", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout DetailItemList ');

            var row = table.insertRow(-1);
            row.className  = 'DetailItemList_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'DetailItemList_item1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'DetailItemList_row_1';

            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'DetailItemList_item2_column';
            col_item2.colSpan = '5';
            ...
            col_item3.className  = 'DetailItemList_item3_column';
            col_item3.colSpan = '7';
            ...
            var row = table.insertRow(-1);
            row.className  = 'DetailItemList_row_2';

            var col_item4 = row.insertCell(-1);
            col_item4.className  = 'DetailItemList_item4_column';
            col_item4.colSpan = '5';
            ...
            col_item5.className  = 'DetailItemList_item5_column';
            col_item5.colSpan = '7';
            ...
            var row = table.insertRow(-1);
            row.className  = 'DetailItemList_row_3';

            var col_item6 = row.insertCell(-1);
            col_item6.className  = 'DetailItemList_item6_column';
            col_item6.colSpan = '5';
            ...
            col_item7.className  = 'DetailItemList_item7_column';
            col_item7.colSpan = '7';
            ...
            var row = table.insertRow(-1);
            row.className  = 'DetailItemList_row_4';

            var col_item8 = row.insertCell(-1);
            col_item8.className  = 'DetailItemList_item8_column';
            col_item8.colSpan = '5';
            ...
            col_item9.className  = 'DetailItemList_item9_column';
            col_item9.colSpan = '7';
            ...
            var row = table.insertRow(-1);
            row.className  = 'DetailItemList_row_5';

            var col_item10 = row.insertCell(-1);
            col_item10.className  = 'DetailItemList_item10_column';
            ...
            col_item11.className  = 'DetailItemList_item11_column';
            col_item11.colSpan = '7';
            ...
            var row = table.insertRow(-1);
            row.className  = 'DetailItemList_row_6';

            var col_item12 = row.insertCell(-1);
            col_item12.className  = 'DetailItemList_item12_column';
            col_item12.colSpan = '5';
            ...
            col_item13.className  = 'DetailItemList_item13_column';
            col_item13.colSpan = '7';
