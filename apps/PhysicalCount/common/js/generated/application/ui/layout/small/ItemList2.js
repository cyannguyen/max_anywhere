...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/ItemList2", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.ItemList2", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            row.className  = 'ItemList2_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'ItemList2_item1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ItemList2_row_1';

            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'ItemList2_item2_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ItemList2_row_2';

            var col_item3 = row.insertCell(-1);
            col_item3.className  = 'ItemList2_item3_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ItemList2_row_3';

            var col_item4 = row.insertCell(-1);
            col_item4.className  = 'ItemList2_item4_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ItemList2_row_4';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'ItemList2_item5_column';
