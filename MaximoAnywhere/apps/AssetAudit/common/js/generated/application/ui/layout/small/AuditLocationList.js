...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/AuditLocationList", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.AuditLocationList", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout AuditLocationList ');

            var row = table.insertRow(-1);
            row.className  = 'AuditLocationList_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'AuditLocationList_item1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'AuditLocationList_row_1';

            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'AuditLocationList_item2_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'AuditLocationList_row_2';

            var col_item3 = row.insertCell(-1);
            col_item3.className  = 'AuditLocationList_item3_column';
