...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/portrait/AuditListItem", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.portrait.AuditListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout AuditListItem ');

            var row = table.insertRow(-1);
            row.className  = 'AuditListItem_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'AuditListItem_item1_column';
            col_item1.colSpan = '4';
            ...
            var row = table.insertRow(-1);
            row.className  = 'AuditListItem_row_1';

            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'AuditListItem_item2_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'AuditListItem_row_2';

            var col_item3 = row.insertCell(-1);
            col_item3.className  = 'AuditListItem_item3_column';
            col_item3.colSpan = '3';
            ...
            col_item4.className  = 'AuditListItem_item4_column';
            col_item4.colSpan = '9';
            ...
            var row = table.insertRow(-1);
            row.className  = 'AuditListItem_row_3';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'AuditListItem_item5_column';
            col_item5.colSpan = '10';
            ...
            col_item6.className  = 'AuditListItem_item6_column';
            col_item6.colSpan = '2';
