...
define("application/business/LocationStatusHandler", 
["dojo/_base/declare",
...
/**@memberOf application.business.LocationStatusHandler */
		init: function(modelDataSet){
			var settings = {};
			settings.resourceName = "location";
	...
	var instance = null;
	var LocationStatusHandler = {};
	LocationStatusHandler.getInstance = function(){		
		if(!instance){
			instance = new thisClass({});
			ModelService.all("domainlocationstatus").then(function(dataSet){
				instance.init(dataSet);
			});					
		}
		return instance;
	};
	return LocationStatusHandler;
});
