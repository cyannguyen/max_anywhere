...
define("application/handlers/AAMoveHandler",
	   [ "dojo/_base/declare",
...
/**@memberOf application.handlers.AAMoveHandler */
		...
		setMoveResource: function(eventContext){
			...
			var view = eventContext.ui.getViewFromId("AssetAudit.AssetMoveView");
		...
		checkBin: function(eventContext){	
			var localMoveResource = eventContext.getCurrentRecord();
		...
		showMove : function(eventContext){
			...
			eventContext.ui.show('AssetAudit.AssetMoveView');
		},
