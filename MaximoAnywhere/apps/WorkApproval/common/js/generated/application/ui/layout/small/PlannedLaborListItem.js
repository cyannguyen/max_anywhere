...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/PlannedLaborListItem", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.PlannedLaborListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout PlannedLaborListItem ');

            var row = table.insertRow(-1);
            row.className  = 'PlannedLaborListItem_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'PlannedLaborListItem_item1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'PlannedLaborListItem_row_1';

            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'PlannedLaborListItem_item2_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'PlannedLaborListItem_row_2';

            var col_item3 = row.insertCell(-1);
            col_item3.className  = 'PlannedLaborListItem_item3_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'PlannedLaborListItem_row_3';

            var col_item4 = row.insertCell(-1);
            col_item4.className  = 'PlannedLaborListItem_item4_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'PlannedLaborListItem_row_4';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'PlannedLaborListItem_item5_column';
