...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/PlannedServiceListItem", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.PlannedServiceListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout PlannedServiceListItem ');

            var row = table.insertRow(-1);
            row.className  = 'PlannedServiceListItem_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'PlannedServiceListItem_item1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'PlannedServiceListItem_row_1';

            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'PlannedServiceListItem_item2_column';
            col_item2.colSpan = '7';
            ...
            col_item3.className  = 'PlannedServiceListItem_item3_column';
            col_item3.colSpan = '2';
            ...
            col_item4.className  = 'PlannedServiceListItem_item4_column';
            col_item4.colSpan = '3';
