...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/ViewCostLine", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.ViewCostLine", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout ViewCostLine ');

            var row = table.insertRow(-1);
            row.className  = 'ViewCostLine_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'ViewCostLine_item1_column';
            ...
            col_item2.className  = 'ViewCostLine_item2_column';
