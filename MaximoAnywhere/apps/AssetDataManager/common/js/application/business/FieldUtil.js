...
/**@memberOf application.business.FieldUtil */
		...
		populateDataObject : function(displayValue, storeField, dataObject){
			dataObject.set(storeField, displayValue);
			if(displayValue == null){ //Then we also need to clear the unit of measure field
				dataObject.set("measureunitid", null);
			}
		},
	};
});
