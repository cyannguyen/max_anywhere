...
//                      }
                ...
                saveDataSheetResource : function(eventContext){
                	...
                	if (eventContext.ui.movingBack){
            			var dataSheetResource = eventContext.application.getResource('dataSheetResource');
            			var dsChangesLookup = {};
            			if(dataSheetResource._changedRecords && Object.keys(dataSheetResource._changedRecords).length > 0){
        				...
        				ModelService.save(dataSheetResource).then(function(ds){
                            ...
                            Logger.traceJSON('[DataSheetHandler.saveDataSheetResource] Failed to save dataSheetResource: ', error);
                                ...
                                // Save Transaction
				this.saveDataSheets(eventContext);
                	}
        	},
