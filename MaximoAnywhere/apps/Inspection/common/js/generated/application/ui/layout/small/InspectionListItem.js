...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/InspectionListItem", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.InspectionListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout InspectionListItem ');

            var row = table.insertRow(-1);
            row.className  = 'InspectionListItem_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'InspectionListItem_item1_column';
            ...
            col_button1.className  = 'InspectionListItem_button1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'InspectionListItem_row_1';

            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'InspectionListItem_item2_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'InspectionListItem_row_2';

            var col_item3 = row.insertCell(-1);
            col_item3.className  = 'InspectionListItem_item3_column';
